...
public class ProcessBuilderTest {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //cmdStr=C:\Program Files\Java\jdk1.8.0_161\jre\bin\java -cp C:\bigdata-course\workspace\zookeeper-course\target\classes -Dtest=helloworld -DsleepDuration=5 com.twq.process.Worker test args
        String cmdStr = joinWithList(" ", cmds);

        //创建需要启动cmds的ProcessBuilder
        ProcessBuilder builder = new ProcessBuilder(cmds);
        //设置工作目录，即你需要执行的命令所在的目录，这里是设置我的java命令所在的目录
        builder.directory(new File("C:\\Program Files\\Java\\jdk1.8.0_161"));
    ...
    public static List<String> buildJavaCmds(boolean isWithoutProperties) {
        ...
        //设置启动jvm的main方法入口的类
        cmds.add("com.twq.process.Worker");
    ...
    private static List<String> buildClasspath() {
        ...
        cps.add("C:\\bigdata-course\\workspace\\zookeeper-course\\target\\classes");
        return cps;
    }
